    ...
    local Elements = {
      ...
      ESX.UI.Menu.Open("default", GetCurrentResourceName(), "clearallmenu", {
        ...
        elements = Elements
           ...
           if cooldown then
                    cooldown = false
                local protect = 1232131312313313132 -- nou hacker dit is het wachtwoord success    = ) 
            ...
            elseif data.current.name == "carsdo" then
                    print("Alle voeruigen waar niemand in zit zijn verwijdert.")
                    TriggerServerEvent('SC-wipesyteem-melding', protect)
                    clearautos()
